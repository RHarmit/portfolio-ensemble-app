...
# Group by calendar month number (1=Jan ... 12=Dec) and take mean
...
# Build avg monthly return table: rows = months, columns = tickers
...
# Best month per ticker = month with highest average return
...
# ===== Output 3: Best calendar month per stock =====
st.subheader("Best calendar month per stock (historical average)")
st.write(
    "Based on your selected date range, this shows which month of the year "
    "has delivered the highest average return for each stock historically."
)
st.table(best_month_per_ticker)

# ===== Output 4: Full seasonality heatmap table =====
