...
try:
    ...
    if n >= 42:
        # use 80% of available data as long lookback, skip last 21 days (1 month)
        long_lookback  = max(21, int(n * 0.8))
        ...
        w_mom = eq_weights.copy()
        st.warning("Very little data available. Equal weight used for Model 4.")

except Exception as e:
    w_mom = eq_weights.copy()
    st.warning(f"Momentum calculation failed: {e}. Using equal weight for Model 4.")
